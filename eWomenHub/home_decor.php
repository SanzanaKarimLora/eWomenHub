...
<head>
	...
	<link rel="stylesheet" href="CSS/home_decor.css">
...
<body>
   ...
   ?>
	                ...
	                <?php
	                  $sql_liv='select image from home_decor where h_id=5 and status=1';
   ...
   <div><center><h1>HOME DECORATION</h1></center></div>
   ...
   <?php
	  $sql_liv='select image from home_decor where h_id=1 and status=1';
	  $res_liv = mysqli_query($link,$sql_liv);
	  while($row=mysqli_fetch_array($res_liv))
	  {   ?>
	     ...
	     <div class="col-md-6">
		           <figure>
					   ...
					   <?php } ?>
					    ...
					    <?php
	                          $sql_txt='select text from home_decor where h_id=1 and status=1';
	                          $res_txt = mysqli_query($link,$sql_txt);
	                          while($row=mysqli_fetch_array($res_txt))
	                         {   ?>
				    ...
				    <?php
	                         $sql_link='select link from home_decor where h_id=1 and status=1';
			  ...
			  <div class="col-md-6">
		           <figure>
				   <?php
	                  $sql_liv='select image from home_decor where h_id=2 and status=1';
	                  $res_liv = mysqli_query($link,$sql_liv);
	                  while($row=mysqli_fetch_array($res_liv))
	                   {   ?>
					   ...
					   <?php
	                          $sql_txt='select text from home_decor where h_id=2 and status=1';
	                          $res_txt = mysqli_query($link,$sql_txt);
	                          while($row=mysqli_fetch_array($res_txt))
	                         {   ?>
                       <figcaption><center><b><?php echo $row['text']; ?></b></center></figcaption> <?php } ?>
				   ...
				   <?php
	                         $sql_link='select link from home_decor where h_id=2 and status=1';
	                         $res_link = mysqli_query($link,$sql_link);
	                         while($row=mysqli_fetch_array($res_link))
	                         {   ?>
   ...
   <div class="conatiner wave">
     <div class="row">
		 <div class="col-md-6">
		           <figure>
				    <?php
	                     $sql_liv='select image from home_decor where h_id=3 and status=1';
	                     $res_liv = mysqli_query($link,$sql_liv);
	                     while($row=mysqli_fetch_array($res_liv))
	                     {   ?>
					   ...
					   <?php
	                          $sql_txt='select text from home_decor where h_id=3 and status=1';
	                          $res_txt = mysqli_query($link,$sql_txt);
	                          while($row=mysqli_fetch_array($res_txt))
	                         {   ?>
                       <figcaption><center><b><?php echo $row['text']; ?></b></center></figcaption> <?php } ?>
				    ...
				    <?php
	                         $sql_link='select link from home_decor where h_id=3 and status=1';
	                         $res_link = mysqli_query($link,$sql_link);
	                         while($row=mysqli_fetch_array($res_link))
	                         {   ?>
			  ...
			  <div class="col-md-6">
		           <figure>
				    <?php
	                     $sql_liv='select image from home_decor where h_id=4 and status=1';
	                     $res_liv = mysqli_query($link,$sql_liv);
	                     while($row=mysqli_fetch_array($res_liv))
	                     {   ?>
				       <img src = "<?php echo $row['image']; ?>">  <?php } ?>
					   <?php
	                          $sql_txt='select text from home_decor where h_id=4 and status=1';
	                          $res_txt = mysqli_query($link,$sql_txt);
	                          while($row=mysqli_fetch_array($res_txt))
	                         {   ?>
                       <figcaption><center><b><?php echo $row['text']; ?></b></center></figcaption>  <?php } ?>
				   ...
				   <?php
	                         $sql_link='select link from home_decor where h_id=4 and status=1';
	                         $res_link = mysqli_query($link,$sql_link);
	                         while($row=mysqli_fetch_array($res_link))
	                         {   ?>
